...
sliderRange.onchange = function() {
  ...
  //Default Map: Landuse
    ...
    if(selected=='landuse'){
      ...
      // document.getElementsByClassName('housing_diff')[0].style.display = 'block';
      ...
      // if (year == 2010){
      //   console.log('2010');
      //   beforeMap.setStyle(housing[0]);
      //   console.log(housingp[0]);
      // }
      // else if (year == 2011){
      //   console.log('2011');
      //   beforeMap.setStyle(housing[1]);
      //   console.log(housing[1]);
      // }
      // else if (year == 2012){
      //   console.log('2012');
      //   beforeMap.setStyle(housing[2]);
      // }
      // else if (year == 2013){
      //   console.log('2013');
      //   beforeMap.setStyle(housing[3]);
      // }    
      // else if (year == 2014){
      //   console.log('2014');
      //   beforeMap.setStyle(housing[4]);
      // }
      // else if (year == 2015){
      //   console.log('2015');
      //   beforeMap.setStyle(housing[5]);
      // }
      // else if (year == 2016){
      //   console.log('2016');
      //   beforeMap.setStyle(housing[6]);
      // }
      // else{
      //   console.log('2017');
      //   beforeMap.setStyle(housing[7]);
      // }

      
      // const afterMap = new mapboxgl.Map({
      //   container: 'housing_after',
      //   style: 'mapbox://styles/jlaa13624/ckwu5lixy3taw14odijdulqfm',
      ...
      // const housing_diff = new mapboxgl.Compare(beforeMap, afterMap, container, {
      // });
      // To be Edit!!!!!
      const map = new mapboxgl.Map({
...
for (const input of inputs) {
  ...
  input.onclick = (layer) => {
    ...
    if(selected_button=='landuse'||selected_button=='income'||selected_button=='education'||selected_button=='population'||selected_button=='transit'||selected_button=='noise'||selected_button=='green'){
      ...
      //   if (year == 2010){
      //     console.log('2010');
      //     beforeMap.setStyle(curr_map[0]);
      //   }
      //   else if (year == 2011){
      //     console.log('2011');
      //     beforeMap.setStyle(curr_map[1]);
      //   }
      //   else if (year == 2012){
      //     console.log('2012');
      //     beforeMap.setStyle(curr_map[2]);
      //   }
      //   else if (year == 2013){
      //     console.log('2013');
      //     beforeMap.setStyle(curr_map[3]);
      //   }    
      //   else if (year == 2014){
      //     console.log('2014');
      //     beforeMap.setStyle(curr_map[4]);
      //   }
      //   else if (year == 2015){
      //     console.log('2015');
      //     beforeMap.setStyle(curr_map[5]);
      //   }
      //   else if (year == 2016){
      //     console.log('2016');
      //     beforeMap.setStyle(curr_map[6]);
      //   }
      //   else{
      //     console.log('2017');
      //     beforeMap.setStyle(curr_map[7]);
      //   }
...
ml.onclick = function(){
  ...
  // map_com.currentPosition;
  // x = window.innerWidth*0.5;
  // map_com.setSlider(x);
  // map_com.on('slideend', (e) => {
  //   console.log(e.currentPosition);
  // });
  // !! Try to set Location of slider:https://github.com/mapbox/mapbox-gl-compare
